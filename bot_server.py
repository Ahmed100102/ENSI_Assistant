...
# Compute semantic similarity and return top-k relevant entries
...
def construct_prompt(question, relevant_entries):
    ...
    prompt += "Based on the provided information, answer the question concisely and accurately."
    return prompt
...
def get_answer():
    ...
    api_key = data.get('api_key', 'YOUR_GEMINI_API_KEY')  # Fallback to default API key if not provided
    ...
    try:
        ...
        JSON_FILE_PATH = "data.json"  # Adjust path if needed
